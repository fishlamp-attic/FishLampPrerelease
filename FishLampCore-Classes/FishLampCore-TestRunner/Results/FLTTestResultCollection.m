...
@implementation FLTTestResultCollection
...
//    id test = [FLTTestResult testResult];
...
//    [self addTestResult:[FLTTestResult testResult:FLTestException what:ex comment:[ex reason]]];

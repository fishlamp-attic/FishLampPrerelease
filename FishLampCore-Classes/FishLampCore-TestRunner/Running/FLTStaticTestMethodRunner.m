...
@interface FLTStaticTestMethodRunner ()
@property (readwrite, strong) NSArray* list;
@end

@implementation FLTStaticTestMethodRunner
...
+ (id) staticTestMethodRunner:(NSArray*) selectorInfoList {
    return FLAutorelease([[FLTStaticTestMethodRunner alloc] init]);
}

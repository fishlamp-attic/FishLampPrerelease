...
+ (SDKColor*) gray10Color; // almost black
+ (SDKColor*) gray15Color;
+ (SDKColor*) gray20Color; 
+ (SDKColor*) gray25Color; 
+ (SDKColor*) gray33Color; // darkGray
+ (SDKColor*) gray45Color;
+ (SDKColor*) gray50Color; // grayColor
+ (SDKColor*) gray66Color; // lightGray
...
//+ (SDKColor*) orangeColor; // 198, 101, 26
